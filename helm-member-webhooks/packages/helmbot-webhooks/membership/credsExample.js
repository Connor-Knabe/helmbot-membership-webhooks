module.exports.giphyAPIKey= "asdfasdfasdfasdf";
module.exports.slackWebhookURL= "https://hooks.slack.com/services/INFOHERE/INFOHERE/INFOHERE";
module.exports.slackDebugWebhookURL= "https://hooks.slack.com/services/INFOHERE/INFOHERE/INFOHERE";
module.exports.slackWebhookSalesUrl = "https://hooks.slack.com/services/INFOHERE/INFOHERE/INFOHERE";
module.exports.helmToSlackNames = {
    "John Smith":"<@LSKDJFJSDF>"
};
module.exports.helmbotUsersUrl = "https://yourshopnamehere.floathelm.com/users/"
